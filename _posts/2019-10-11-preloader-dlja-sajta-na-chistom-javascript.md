---
title: Прелоадер для сайта на чистом Javascript
layout: post
author: jora
categories: codes
subj_color: greengi
...
comments: true
---
![Preloader для сайта на Javascript]({{ site.url }}/assets/img/preloader_javascript.jpg)
Пример простого Preloader для сайта на Javascript
